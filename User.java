...
public class User
{
    ...
    {
        for(Friendship friends : friendships)
        {
          if (friends.targetUser == friend)
          {
            return true;
          }    
        }        
    ...
    public void displayFriends(Status status) 
    {
        ...
        for(Friendship friends : friendships)
        {
            if (friends.targetUser.status == status)
            {
              System.out.println("My friend " + friends.targetUser.firstName + " is " + friends.targetUser.status);  
            }    
        }   
    }
